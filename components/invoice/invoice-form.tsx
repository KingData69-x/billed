...
export function InvoiceForm({ profile, clients, monthlyCount }: InvoiceFormProps) {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      const fakeProfile = profile ?? { id: "", email: "", full_name: "Your Business", business_name: null, business_email: null, business_phone: null, business_address: null, plan: "free" as const, stripe_customer_id: null, invoice_count: 0, created_at: "" };
      const fakeInvoice = {
